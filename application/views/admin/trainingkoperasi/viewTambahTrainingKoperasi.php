...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">    
    ...
    <form name="form" id="form1" class="form-horizontal" enctype="multipart/form-data" method="POST" style="margin-top: 0px; margin-bottom: 0px" action="<?php echo base_url(); ?>trainingKoperasi/insertTrainingKoperasi">
        <div class="col-md-12">
            <div class="panel panel-default">
              <div class="panel-heading">Tambah Pelatihan Koperasi</div>
              <div class="panel-body" style="margin-left: 20px">
                  ...
                  <div class="row">
                    ...
                    <div class="input-group">                     
                      <input name="judulTraining" style="height: 34px;" type="text" id="judulTraining" class="form-control" required>
                    </div>
                    </div>
                  </div></br>
                  ...
                  <div class="col-md-3 form-group">                   
                      ...
                      <input type="text" id="datetimepicker2" style="min-height:34px" name="tanggalTraining">
                      </div>
                  </div>
                  </div></br>                  
                  ...
                  <div class="row row-table">
                      <div class="col-md-2 col-xs-12 col-table form-group" style="margin-right: 10px">
                          <div class="col-content md">
                              <label>Lokasi</label>
                              <div class="input-group">
                              <input name="lokasiTraining" style="height: 34px;" type="text" id="lokasiTraining" class="form-control" required>
                              </div>
                          </div>
                      </div>
                      <div class="col-md-2 col-xs-12 col-table form-group" style="margin-right: 10px">
                          <div class="col-content md">
                              ...
                              <div class="input-group">                      
                              <input name="durasiTraining" style="height: 34px;" type="text" id="durasiTraining" class="form-control" required>
                              </div>
                          </div>
                      </div>
                      <div class="col-md-2 col-xs-12 col-table form-group" style="margin-right: 10px">
                          <div class="col-content md">
                              ...
                              <div class="input-group">
                              <input name="kuotaTraining" style="height: 34px;" type="number" id="kuotaTraining" class="form-control" required>
                              </div>
                          </div>
                      </div>
                  </div></br>                  
                  ...
                  <div class="row">
                    <div class="col-md-4 col-xs-12 form-group">
                      <label>Gambar</label>
                      <input type="file" id="foto"  name="foto" style="height:40px;" class="form-control">
                    </div>
                  </div> 
                  <br>
