<?php 
//print_r($result['data2']['tabunganproduk_id']);die();
?>
...
<div class="modal fade" id="setor" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header" style="background-color: #203864;">
        <button type="button" class="close" data-dismiss="modal" style="color:white;">&times;</button>
        <h4 class="modal-title" style="color:white;">Setor Simpanan Syariah</h4>
      </div>

      <form name="form1" id="form1" class="form-horizontal" enctype="multipart/form-data" method="POST" style="margin-top: 0px; margin-bottom: 0px; margin-left:15px" action="<?php echo base_url(); ?>SimpananNasabah/setorSimpananBMT">
        <div class="modal-body edit-content">
          <input type="hidden" id="tabunganproduk_id" name="tabunganproduk_id" value="<?php echo $result['data2']['tabunganproduk_id'] ?>">
          <input type="hidden" id="anggotakoperasi_id" name="anggotakoperasi_id" value="<?php echo $result['data2']['anggotakoperasi_id'] ?>">
          <input type="hidden" id="rekening" name="rekening" value="<?php echo $result['data2']['rekening'] ?>">
          <input type="hidden" id="tab_id" name="tab_id" value="<?php echo $result['data2']['tab_id'] ?>">

          <div class="box-body">
              <div class="form-group">
              <label class="control-label col-sm-4" >No Bukti : </label>
              <div class="col-md-6">
          ...
          <div class="box-body">
              <div class="form-group">
              <label class="control-label col-sm-4" >Setoran : </label>
              <div class="col-md-6">
          ...
          <div class="box-body">
              <div class="form-group">
              <label class="control-label col-sm-4" >Tanggal Ambil :</label>
              <div class="col-md-6">
                <input type="text" id="tanggalambil" name="tanggalambil" value="<?php echo $result['data2']['diambilpada'] ?>" class="form-control">
              </div>
            </div>
          </div>
          ...
          <div class="box-body">
              <div class="form-group">
              <label class="control-label col-sm-4" >Reference Number SSP :</label>
              <div class="col-md-6">
                <input type="text" id="refNumberSSP" name="refNumberSSP" class="form-control" required>
              </div>
            </div>
          ...
          <div class="box-body">
              <div class="form-group">
              <label class="control-label col-sm-4" >Penyetor :</label>
              <div class="col-md-6">
          ...
          <div class="box-body">
              <div class="form-group">
              <label class="control-label col-sm-4" >Metode</label>
              <div class="col-md-6">
                  <select name="metode" class="form-control" id="metode" required>
                    <option value="">- Pilih Metode -</option>
                    <option value="Cash">Cash</option>
    ...
    <div class="row">
      <div class="col-lg-12">
        <div class="panel panel-default">
          <div class="panel-heading"><b>Mutasi Simpanan Syariah</b>&nbsp;&nbsp;
              <!-- <a class="btn-sm btn-primary" href ="<?= base_url('SimpananNasabah/index') ?>">Tambah Simpanan</a> -->
              <a href ="#" class="edit" data-toggle="modal" data-target="#ambilSimpanan" data-indikator="<?php echo $id; ?>"><button class="btn btn-success btn-xs">Ambil</button></a>
                       &nbsp;
                       <a class="btn-sm btn-danger" href ="<?= base_url('SimpananNasabah/hapusNasabah') ?>/<?php echo $id?>" onclick="return confirm('Apakah Anda yakin ingin menghapus nasabah ini?');">
                       Hapus</a>
                       &nbsp;
                       <a href ="#" class="" data-toggle="modal" data-target="#setor" data-indikator="<?php echo $id; ?>"><button class="btn-xs btn-primary">Setor</button></a>
          </div>
            ...
            <tbody>
                <?php
                  ...
                  <tr>
                      ...
                      <td><?php echo "Rp ".number_format ($row['balance'], 2, ',', '.');?></td>
                      <!-- <td>
