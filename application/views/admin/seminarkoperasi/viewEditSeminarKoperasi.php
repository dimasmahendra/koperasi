...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">    
    ...
    <form name="form" id="form1" class="form-horizontal" enctype="multipart/form-data" method="POST" style="margin-top: 0px; margin-bottom: 0px" action="<?php echo base_url(); ?>seminarKoperasi/updateSeminar">
        <div class="col-md-12">
            <div class="panel panel-default">
              <div class="panel-heading">Edit Seminar Koperassi</div>
              <div class="panel-body" style="margin-left: 20px">

                  <div class="row">
                    <div class="col-md-2 form-group">                  
                      <input type="hidden" value="<?php echo $this->uri->segment(3); ?>" name="seminarkoperasi_id">
                    </div>
                  </div> 
                  ...
                  <div class="row">
                    ...
                    <div class="input-group">
                      <input name="judul" type="text" id="judul" class="form-control" style="height: 34px;" value= "<?php echo $judul; ?>" required>
                    </div>
                    </div>
                  </div></br>
                  ...
                  <div class="row row-table">
                      <div class="col-md-2 col-xs-12 col-table form-group" style="margin-right: 10px">
                          <div class="col-content md">
                              <label>Lokasi</label>
                              <div class="input-group">
                              <input name="lokasi" type="text" id="lokasi" class="form-control" style="height: 34px;" value= "<?php echo $tempat; ?>" required>
                              </div>
                          </div>
                      </div>
                      <div class="col-md-2 col-xs-12 col-table form-group" style="margin-right: 10px">
                          <div class="col-content md">
                              ...
                              <div class="input-group">
                              <input name="durasi" type="text" id="durasi" class="form-control" style="height: 34px;" value= "<?php echo $durasi; ?>" required>
                              </div>
                          </div>
                      </div>
                      <div class="col-md-2 col-xs-12 col-table form-group" style="margin-right: 10px">
                          <div class="col-content md">
                              ...
                              <div class="input-group">
                              <input name="kuota" type="number" id="kuota" class="form-control" style="height: 34px;" value= "<?php echo $kapasitas; ?>" required>
                              </div>
                          </div>
                      </div>
                  </div></br>                  
                  ...
                  <div class="row">
                   ...
                   <div class="row" style="margin-left:10px;">
                        ...
                        <img src="<?php echo URL_IMG ?>images/no_image.png" rel="stylesheet" class="img-responsive" alt="Cinque Terre" width="300" height="300">

                        <?php } else { ?>
                      
                        <img src ="<?php echo URL_IMG ?>/images/seminarkoperasi/<?php echo $foto; ?>" rel="stylesheet" class="img-responsive" alt="Cinque Terre" width="300" height="300">
                  ...
                  <div class="pull-right">                   
                      <button class="btn btn-default"><a href="<?php echo base_url(); ?>seminarKoperasi/daftarSeminarKoperasi">Batal</a></button>
