...
@media
  ...
  */
  #tabelAnggotaKoperasi td:before { content: attr(data-title); }
    ...
    #tabelAnggotaKoperasi td:nth-of-type(4):before { content: "Tanggal"; text-align: left;}
    #tabelAnggotaKoperasi td:nth-of-type(5):before { content: "Tempat"; text-align: left;}
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="panel panel-default">
            <div class="panel-heading">Daftar Seminar Koperasi&nbsp;&nbsp;
                <a class="btn-sm btn-primary visible-lg-inline-block" href ="<?= base_url('seminarKoperasi/index') ?>">Tambah Seminar
                </a>
                <a class="btn-sm btn-primary hidden-lg" href ="<?= base_url('seminarKoperasi/index') ?>"><svg class="glyph stroked plus sign"><use xlink:href="#stroked-plus-sign"/></svg> Seminar
                </a>
            </div>
                        ...
                        { ?>                 
                              <tr>
                                  ...
                                  <td>
                                    ...
                                    <img src ="<?php echo URL_IMG ?>images/seminarkoperasi/thumb_<?php echo $row['foto']; ?>" rel="stylesheet" class="img-circle" alt="Cinque Terre" width="50" height="50">

                                    <?php  } ?>                                            
                                  </td>                                          
                                  <td>                               
                                   <a class="btn-sm btn-primary" href ="<?= base_url('seminarKoperasi/ubahSeminarKoperasi') ?>/<?php echo $row['id']?>">
                                   Edit</a></br></br>                                   
                                   <a class="btn-sm btn-danger" href ="<?= base_url('seminarKoperasi/hapusSeminar') ?>/<?php echo $row['id']?>" onclick="return confirm('Apakah Anda yakin ingin menghapus Seminar Koperasi ini?');">
                                   Hapus</a> 
                                  </td>
                              </tr>
                      <?php } ?>        
