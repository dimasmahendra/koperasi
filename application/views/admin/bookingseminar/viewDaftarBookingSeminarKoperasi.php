      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="panel panel-default">
            <div class="panel-heading">Daftar Booking Seminar Koperasi</div>
                      ...
                      <?php 
                        ...
                        { ?>                 
                              <tr>
                                  ...
                                  <td>                               
                                    <a class="btn-sm btn-primary" href ="<?= base_url('bookingSeminar/daftarPemesanBookingSeminar') ?>/<?php echo $row['id']?>">Lihat Peserta</a>                                   
                                  </td>
                              </tr>
                      <?php } ?>        
                  </tbody>              
