...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">    
    ...
    <form name="form" id="form1" class="form-horizontal" enctype="multipart/form-data" method="POST" style="margin-top: 0px; margin-bottom: 0px" action="<?php echo base_url(); ?>infoKoperasi/updateInfoKoperasi">
        <div class="col-md-12">
            <div class="panel panel-default">
              <div class="panel-heading">Edit Informasi Koperasi</div>
              <div class="panel-body" style="margin-left: 20px">

                  <div class="row">
                    <div class="col-md-2 form-group">                  
                      <input type="hidden" value="<?php echo $this->uri->segment(3); ?>" name="infokoperasi_id">
                    </div>
                  </div>
                  ...
                  <div class="row" style="margin-left:10px;">
                    ...
                    <?php } else { ?>                  
                    <img src ="<?php echo URL_IMG ?>/images/infokoperasi/<?php echo $foto; ?>" rel="stylesheet" class="img-responsive" alt="Cinque Terre" width="300" height="300">
                    <?php  } ?>                
                  </div></br>
                  ...
                  <div class="row">
                    <div class="col-md-4 form-group">  
                      ...
                      <input name="judul" type="text" id="judul" class="form-control" placeholder="Judul Artikel" style="height: 34px;" value= "<?php echo $judul; ?>" required>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="pull-right">
                    <a href="<?php echo base_url(); ?>index.php/infoKoperasi/daftarInfoKoperasi"><button type="button" class="btn btn-default">Batal</button></a>
