...
@media
  ...
  */
  #tabelAnggotaKoperasi td:before { content: attr(data-title); }
    ...
    #tabelAnggotaKoperasi td:nth-of-type(5):before { content: "Jenis Kelamin"; text-align: left;}
    #tabelAnggotaKoperasi td:nth-of-type(6):before { content: "Username"; text-align: left;}
    #tabelAnggotaKoperasi td:nth-of-type(7):before { content: "Alamat"; text-align: left;}
    #tabelAnggotaKoperasi td:nth-of-type(8):before { content: "Status"; text-align: left;}
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="panel panel-default">
            <div class="panel-heading">Daftar Peserta Pelatihan Koperasi</div>
