      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="panel panel-default">
            <div class="panel-heading">Daftar Seminar Kementerian</div>
                        ...
                        { ?>                 
                              <tr>
                                  ...
                                  <td>
                                    ...
                                    <?php } else { ?>                                    
                                    <img src ="<?php echo URL_IMG ?>images/seminarkementerian/thumb_<?php echo $row['foto']; ?>" rel="stylesheet" class="img-circle" width="50" height="50">

                                    <?php  } ?>
                                  </td>                                          
                                  <td>
                                  <a class="button" href ="<?= base_url('SeminarMenteri/daftarDetilSeminar') ?>/<?php echo $row['id']?>"><button class="btn btn-primary btn-xs">Lihat Pesan</button></a>&nbsp;                               
                                  <a class="button" href ="<?= base_url('SeminarMenteri/daftarPesertaSeminarMenteri') ?>/<?php echo $row['id']?>"><button class="btn btn-warning btn-xs">Daftar Peserta</button></a>                             
                                  </td>
                              </tr>
                      <?php } ?>        
                  </tbody>              
