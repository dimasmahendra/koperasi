...
@media
  ...
  */
  #tabelAnggotaKoperasi td:before { content: attr(data-title); }
    ...
    #tabelAnggotaKoperasi td:nth-of-type(5):before { content: "Status"; text-align: left;}
    ...
    #tabelAnggotaKoperasi td:nth-child(7) { width: 50%;text-align: right;}
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="panel panel-default">
            <div class="panel-heading">Daftar Pelatihan Kementerian Anggota Koperasi</div>
                      ...
                      <?php 
                        ...
                        { ?>                 
                              <tr>
                                  ...
                                  <td>
                                    <form name="form1" id="form1" class="form-horizontal" enctype="multipart/form-data" method="POST" action="<?php echo base_url(); ?>TrainingMenteri/updateTrainingMenteri">
                                      ...
                                      <input type="hidden" value="<?php echo $row['trainingkementerian_id'];?>" name="trainingkementerian_id"></input>
                                  ...
                                  <td>
                                    <form name="form1" id="form1" class="form-horizontal" enctype="multipart/form-data" method="POST" action="<?php echo base_url(); ?>TrainingMenteri/hapusTrainingMenteri">
                                      <input type="hidden" value="<?php echo $this->uri->segment(3); ?>" name="url"></input>
                                      <input type="hidden" value="<?php echo $row['id'];?>" name="bookingtrainingkementerian_id"></input> 
                                      <button href="#" id="tombolSimpan" type="submit" class="btn-sm btn-danger" onclick="return confirm('Apakah Anda yakin ingin menghapus Peserta Training ini?');">Hapus</button>
                                    </form>
                                  </td>                               
                              </tr>
                      <?php } ?>        
