...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
    <div class="row">
      ...
      <form name="form" id="form" class="form-horizontal" enctype="multipart/form-data" method="POST" style="margin-top: 0px; margin-bottom: 0px" action="<?php echo base_url(); ?>Pelanggan/tambahPelanggan">    
          ...
          <div class="panel-body" style="margin-left: 20px">              
              ...
              <div class="row"> 
                ...
                <div>                  
                    ...
                    <button class="btn btn-default" name="button" id="tombolReset" value="true" type="reset">Reset</button> 
                </div>          
          </div>
      </div>
    </div>
