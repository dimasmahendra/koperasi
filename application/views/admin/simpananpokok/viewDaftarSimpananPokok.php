...
@media
  ...
  */
  #tabelAnggotaKoperasi td:before { content: attr(data-title); }
    ...
    #tabelAnggotaKoperasi td:nth-of-type(3):before { content: "Tanggal Bayar"; text-align: left;}
    #tabelAnggotaKoperasi td:nth-of-type(4):before { content: "Jumlah"; text-align: left;}
    ...
    <div class="row">
      <div class="col-lg-12">
        <div class="panel panel-default">
          <div class="panel-heading">Daftar Simpanan Pokok
              <!-- <a class="btn-sm btn-primary" href ="<?= base_url('SimpananPokok/index') ?>">Tambah Simpanan</a> -->
          </div>
          ...
          <table id="tabelAnggotaKoperasi" class="display" cellspacing="0" width="100%">
                ...
                <tr>
                  ...
                  <td>                               
                                 <a class="btn-sm btn-primary" href ="<?= base_url('SimpananPokok/ubahSimpananPokok') ?>/<?php echo $row['id']?>">
                                 Edit</a>
                                 &nbsp;
                                 <a class="btn-sm btn-danger" href ="<?= base_url('SimpananPokok/hapusSimpananPokok') ?>/<?php echo $row['id']?>" onclick="return confirm('Apakah Anda yakin ingin menghapus data simpanan ini?');">
                                 Hapus</a> 
                  </td> -->
                </tr>
                <?php } } ?>
